...
4. Each tracked `.codex/` is a real directory whose immediate children are relative symlinks to the corresponding entries in its sibling `.claude/`. Keep `.claude/` canonical and do not duplicate agent or skill indexes in `AGENTS.md`.
