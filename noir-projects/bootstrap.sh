...
# Format check across the noir-projects workspaces. CI runs this via the root Makefile's
# noir-projects-format-check target. The check also warms the shared nargo
