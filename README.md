...
The projects in this repo are released via npm ([@aztec-labs](https://www.npmjs.com/org/aztec-labs)) and DockerHub ([azteclabs/aztec](https://hub.docker.com/r/azteclabs/aztec)).
