...
sed -i \
  -e 's|aztec = .*git.*AztecProtocol/aztec-nr.*|aztec = { path="/home/ubuntu/aztec-node/noir-projects/aztec-nr/aztec" }|' \
  -e 's|balance_set = .*git.*AztecProtocol/aztec-nr.*|balance_set = { path="/home/ubuntu/aztec-node/noir-projects/aztec-nr/balance-set" }|' \
...
sed -i \
  's|aztec = .*git.*AztecProtocol/aztec-nr.*|aztec = { path="/home/ubuntu/aztec-node/noir-projects/aztec-nr/aztec" }|' \
