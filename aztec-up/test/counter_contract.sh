...
cp -Rf ./aztec-node/noir-projects/noir-contracts/contracts/test/counter/* counter/
cd counter
sed -i 's|\.\./\.\./\.\./\.\./\.\./|/home/ubuntu/aztec-node/noir-projects/|g' counter_contract/Nargo.toml counter_test/Nargo.toml
