...
import { BlockProposal, CheckpointAttestation } from '@aztec-labs/stdlib/p2p';
import { CheckpointHeader } from '@aztec-labs/stdlib/rollup';
import { type MakeConsensusPayloadOptions, makeBlockProposal } from '@aztec-labs/stdlib/testing';
