...
import { type TokenContract, TokenContractArtifact } from '@aztec-labs/noir-contracts.js/Token';
import { AuthWitTestContract, AuthWitTestContractArtifact } from '@aztec-labs/noir-test-contracts.js/AuthWitTest';
