...
// - 2026-08-27: total now counts runtime JS only, excluding external `.map` sourcemaps (~67% of the old
//   number). Reset to 6 MiB against ~4.65 MiB of JS today; reverts the 14.5 stopgap. Sourcemap total gets
