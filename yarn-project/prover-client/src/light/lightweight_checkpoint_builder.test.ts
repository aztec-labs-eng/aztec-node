import { EMPTY_EPOCH_OUT_HASH } from '@aztec-labs/constants';
...
import { accumulateCheckpointOutHashes, appendL1ToL2MessagesToTree } from '@aztec-labs/stdlib/messaging';
import { mockProcessedTx } from '@aztec-labs/stdlib/testing';
import { MerkleTreeId, PublicDataTreeLeaf } from '@aztec-labs/stdlib/trees';
import type { CheckpointGlobalVariables, ProcessedTx } from '@aztec-labs/stdlib/tx';
