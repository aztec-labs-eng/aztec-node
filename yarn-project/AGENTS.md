...
Conventional commit types, branch strategy, and base-branch detection live in the root `AGENTS.md` under `<git_workflow>`. The sections below cover only yarn-project-specific additions.
