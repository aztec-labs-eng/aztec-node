...
references: ["aztec-up/*", "yarn-project/cli-wallet/src/*", "noir-projects/noir-contracts/contracts/app/token_contract/*", "noir-projects/noir-contracts/contracts/fees/sponsored_fpc_contract/*"]
---
