...
references: ["yarn-project/pxe/src/hooks/*", "noir-projects/aztec-nr/aztec/src/test/helpers/test_environment.nr", "noir-projects/noir-contracts/contracts/standard/handshake_registry_contract/*"]
---
