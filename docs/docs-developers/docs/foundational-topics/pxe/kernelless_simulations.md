...
references: ["yarn-project/pxe/src/contract_function_simulator/*", "yarn-project/stdlib/src/tx/simulated_tx.ts", "yarn-project/wallets/src/embedded/embedded_wallet.ts", "noir-projects/noir-contracts/contracts/account/simulated_schnorr_account_contract/*", "noir-projects/noir-contracts/contracts/account/simulated_ecdsa_account_contract/*"]
---
