...
sidebar_position: 3
references: ["noir-projects/aztec-nr/aztec/src/messages/discovery/*", "noir-projects/aztec-nr/aztec/src/messages/delivery/*", "yarn-project/pxe/src/tagging/*", "noir-projects/noir-contracts/contracts/standard/handshake_registry_contract/*"]
---
